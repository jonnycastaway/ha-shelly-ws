...
class ShellyPowerSensor(SensorEntity):
    ...
    def _handle_disconnected(self) -> None:
        # Letzte Messwerte bleiben sichtbar – nicht auf unavailable setzen
        pass

    @callback
    def _handle_update(self, data: dict) -> None:
        """Process NotifyStatus push or initial GetStatus result."""
        desc: ShellySensorDescription = self.entity_description
        ...
        # aenergy ist ein verschachteltes Objekt: {"total": float, ...}
